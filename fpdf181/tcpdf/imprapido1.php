...
// -------------------------------------------------------------------
$nombre="./archivos/controlvisiteurs/"."eliminar.pdf";
...
?>
<script>
//alert ("Enregistré Correctement");
window.open('example.pdf');
//window.location=("plantill005k.php?fecha="+fechahoy);
//location.href="plantill005e.php";
</script>

...
$sel_lineas="SELECT tablag.*,tablap.* FROM tablag,tablap WHERE tablag.datepr='$datepr' AND tablag.recete=tablap.recete";
$modificar1=mysql_query($sel_lineas);
$nrs=mysql_num_rows(modificar1);



$head = array('HeureD', 'Recette', 'Melange', 'Code', 'Kg', 'DateProd', 'Lote', 'Kg(et/ou)', 'Nb.Sac', 'Lot', 'Eau.Kg', 'Glace', 'Code', 'Kg', 'Lot', 'Poids', 'Temp', 'HeureF'); // cabecera 

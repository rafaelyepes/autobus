...
<!--        
      ...
      <!-- aqui va el carrusel de la imagen-->
      <div id="result_strip">
      ...
      <!-- aqui va la respuesta de la imagen capturada-->
    ...
    <div  class="panel panel-primary" style="margin:20px;">
     ...
     <form>
        <div class="row">
         ...
         <div class="col-sm-4 form-group">
         <input style="text-align: left;" type="text" placeholder="Champ requis" class="form-control form-controlred" value="<?php echo ($bus)?>" onblur="abrir()" id="bus" name="bus" readonly>
         </div>
         <div class="col-sm-4 form-group">
         <div class="upload1">
         <div class="controls upload1 center-block">
         ...
         <div class="col-sm-4 form-group">
         <input style="text-align: left;" type="text" placeholder="Champ requis" class="form-control form-controlred" value="<?php echo ($chofer)?>" id="chofer" name="chofer" readonly>
         </div>  
         <div class="col-sm-4 form-group">
         <div class="upload1">
         <div class="controls upload1 center-block">
